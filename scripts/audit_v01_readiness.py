...
ALGORITHM_CONFIGS = {
    ...
    "fwi_kwave_adapter": "configs/algorithms/fwi_kwave_full_pipeline.yaml",
}
...
REQUIRED_FILES = [
    ...
    "scripts/render_readme_algorithm_comparison.py",
    ...
    "configs/benchmarks/travel_time_surrogate_main.yaml",
    "configs/benchmarks/kwave_fwi_main.yaml",
    "configs/benchmarks/synthetic_smoke.yaml",
    ...
    "configs/benchmarks/archive/README.md",
    "configs/algorithms/fwi_kwave_full_pipeline.yaml",
    "configs/algorithms/experimental/README.md",
]
...
REQUIRED_TESTS = [
    ...
    "tests/test_render_class_comparison_panels.py",
