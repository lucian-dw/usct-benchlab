% usct-benchlab wrapper for rehmanali1994/refractionCorrectedUSCT.github.io.
%
...
%
% The public repository exposes the eikonal projection and Laplacian pieces
% used by ctReconLaplacianRegularized.m, especially Functions/eikProjMat.m and
% Functions/laplacianOperator.m. This wrapper keeps the usct-benchlab HDF5
% contract local and performs a small regularized Gauss-Newton style
% travel-time solve that can be used as an external MATLAB smoke entrypoint.
