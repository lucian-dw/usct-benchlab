...
REQUIRED = [
    ...
    "docs/assets/reconstruction/openbreastus_matched.png",
    "docs/assets/reconstruction/nbpslice2d_matched.png",
    "docs/assets/reconstruction/openbreastus_kwave.png",
    "docs/assets/reconstruction/nbpslice2d_kwave.png",
    "docs/assets/reconstruction/metrics.csv",
    "docs/assets/reconstruction/manifest.json",
    "examples/README.md",
